...
import 'package:segak/screen/exam/penggal_2/u3_p2.dart';

class Ujian3TimerPen2 extends StatefulWidget {
  @override
  _Ujian3TimerPen2State createState() => _Ujian3TimerPen2State();
}

final double _headerHeight = 250;

class _Ujian3TimerPen2State extends State<Ujian3TimerPen2> {
            ...
            onClicked: () {
              if (donetekan == "Mula") {
                ...
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                    builder: (context) => Ujian3TekanPen2(),
                  ),
                );
              }
            },
