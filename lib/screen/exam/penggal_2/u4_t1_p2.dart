...
import 'package:segak/screen/exam/penggal_2/u4_p2.dart';

class Ujian4TimerPen2 extends StatefulWidget {
  @override
  _Ujian4TimerPen2State createState() => _Ujian4TimerPen2State();
}

final double _headerHeight = 250;

class _Ujian4TimerPen2State extends State<Ujian4TimerPen2> {
            ...
            onClicked: () {
              if (donetekan == "Mula") {
                ...
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                    builder: (context) => Ujian4RingkukPen2(),
                  ),
                );
              }
            },
