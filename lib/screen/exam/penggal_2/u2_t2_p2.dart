...
import 'package:segak/screen/exam/penggal_2/u2_p2.dart';

class Ujian2TimerNadiPen2 extends StatefulWidget {
  @override
  _Ujian2TimerNadiPen2State createState() => _Ujian2TimerNadiPen2State();
}

final double _headerHeight = 250;

class _Ujian2TimerNadiPen2State extends State<Ujian2TimerNadiPen2> {
            ...
            onClicked: () {
              if (donenaik == "Mula") {
                ...
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                    builder: (context) => Ujian2NaikPen2(),
                  ),
                );
              }
            },
