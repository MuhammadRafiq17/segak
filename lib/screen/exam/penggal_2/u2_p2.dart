...
class Ujian2NaikPen2 extends StatefulWidget {
  Ujian2NaikPen2({super.key});

  @override
  State<Ujian2NaikPen2> createState() => _Ujian2NaikPen2State();
}

class _Ujian2NaikPen2State extends State<Ujian2NaikPen2> {
