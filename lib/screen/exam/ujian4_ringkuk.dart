...
class LihatRingkuk extends StatefulWidget {
  const LihatRingkuk({super.key});

  @override
  State<LihatRingkuk> createState() => _LihatRingkukState();
}

class _LihatRingkukState extends State<LihatRingkuk> {
  String? ringkuk = "";
  String? age = "";
  String? score = "";
  String isExist = "";
          ...
          if (documentSnapshot2.exists) {
            ...
            await FirebaseFirestore.instance
              ...
              if (documentSnapshot3.exists) {
                ringkuk = documentSnapshot3.get('ringkuk').toString();
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            const Text(
                              'Bilangan Ringkuk Tubi Separa dan Skor Anda',
                              textAlign: TextAlign.center,
                    ...
                    SafeArea(
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            const Text(
                              'Bilangan Ringkuk Tubi',
                              textAlign: TextAlign.center,
                              style: TextStyle(
                                  fontSize: 40, fontWeight: FontWeight.bold),
                            ),
                            const Text(
                              'Bilangan Ringkuk Tubi dan Skor Anda',
                              textAlign: TextAlign.center,
                              style: TextStyle(color: Colors.grey),
                            ),
                            const SizedBox(height: 10.0),
