...
class LihatTekan extends StatefulWidget {
  const LihatTekan({super.key});

  @override
  State<LihatTekan> createState() => _LihatTekanState();
}

class _LihatTekanState extends State<LihatTekan> {
  String? tekan = "";
  String? age = "";
  String? score = "";
  String isExist = "";
          ...
          if (documentSnapshot2.exists) {
            ...
            await FirebaseFirestore.instance
              ...
              if (documentSnapshot3.exists) {
                tekan = documentSnapshot3.get('tekan').toString();
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            const Text(
                              'Bilangan Tekan Tubi dan Skor Anda',
                              textAlign: TextAlign.center,
